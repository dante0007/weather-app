...
abstract final class StaticScreenBuilder {
  static Widget build(StaticScenario scenario) {
    return switch (scenario) {
      ...
      StaticScenario.configViewerB =>
        ConfigViewerScreen(scenario: scenario),
  ...
  static String label(StaticScenario scenario) {
    return switch (scenario) {
      ...
      StaticScenario.debugFabCollapsed => '08 · Debug FAB · Collapsed',
      StaticScenario.debugPanelA => '09 · Debug Panel · Config A',
...
/// Standalone static screens outside the 15 design frames.
abstract final class StaticExtraScreens {
  static Widget sevenDayForecast() => const SevenDayForecastScreen();
}

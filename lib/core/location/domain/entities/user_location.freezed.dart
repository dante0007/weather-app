...
mixin _$UserLocation {
 ...
 double get latitude; double get longitude; String get cityName; String get countryCode; String get countryName;
...
@override
int get hashCode => Object.hash(runtimeType,latitude,longitude,cityName,countryCode,countryName);

@override
String toString() {
  return 'UserLocation(latitude: $latitude, longitude: $longitude, cityName: $cityName, countryCode: $countryCode, countryName: $countryName)';
}
...
@useResult
$Res call({
 double latitude, double longitude, String cityName, String countryCode, String countryName
});
...
/// Create a copy of UserLocation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? latitude = null,Object? longitude = null,Object? cityName = null,Object? countryCode = null,Object? countryName = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double latitude,  double longitude,  String cityName,  String countryCode,  String countryName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserLocation() when $default != null:
return $default(_that.latitude,_that.longitude,_that.cityName,_that.countryCode,_that.countryName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double latitude,  double longitude,  String cityName,  String countryCode,  String countryName)  $default,) {final _that = this;
switch (_that) {
case _UserLocation():
return $default(_that.latitude,_that.longitude,_that.cityName,_that.countryCode,_that.countryName);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double latitude,  double longitude,  String cityName,  String countryCode,  String countryName)?  $default,) {final _that = this;
switch (_that) {
case _UserLocation() when $default != null:
return $default(_that.latitude,_that.longitude,_that.cityName,_that.countryCode,_that.countryName);case _:
  return null;
...
class _UserLocation implements UserLocation {
  const _UserLocation({required this.latitude, required this.longitude, required this.cityName, required this.countryCode, required this.countryName});
...
/// Create a copy of UserLocation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? latitude = null,Object? longitude = null,Object? cityName = null,Object? countryCode = null,Object? countryName = null,}) {
